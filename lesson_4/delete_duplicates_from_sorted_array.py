# Write a program that take as input a sorted array and updates it so that all duplicates have been removed and the remaining
# elements have been shifted left to fill the emptied indices.
# Fill the number of valid elements.
